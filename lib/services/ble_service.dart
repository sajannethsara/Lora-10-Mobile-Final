...
class BleService {
  ...
  static final Guid inboxSizeUuid = Guid('12345678-1234-5678-1234-56789abcdef1');
  static final Guid inboxIndexUuid = Guid('12345678-1234-5678-1234-56789abcdef2');
  static final Guid inboxDataUuid = Guid('12345678-1234-5678-1234-56789abcdef3');
  static final Guid inboxNotifyUuid = Guid('12345678-1234-5678-1234-56789abcdef4');

  static final Guid sentboxSizeUuid = Guid('12345678-1234 -5678-1234-56789abcdef5');
  static final Guid sentboxIndexUuid = Guid('12345678-1234-5678-1234-56789abcdef6');
  static final Guid sentboxDataUuid = Guid('12345678-1234-5678-1234-56789abcdef7');
  static final Guid sentboxNotifyUuid = Guid('12345678-1234-5678-1234-56789abcdef8');
  ...
  static final Guid gpsNotifyUuid = Guid('12345678-1234-5678-1234-56789abcdefc');

  static final Guid writeMessageUuid = Guid('12345678-1234-5678-1234-56789abcdefd');

  StreamSubscription? _notificationSubscription;

Future<List<ScanResult>> scan() async {
  try {
    // Start scanning with a filter for the target service UUID
