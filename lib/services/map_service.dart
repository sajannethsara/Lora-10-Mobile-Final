...
class MapService extends ChangeNotifier {
  ...
  // Getter for current area key
  String? get currentAreaKey => _currentAreaKey;

  // Predefined hiking areas
  final Map<String, Map<String, dynamic>> _hikingAreas = {
    'colombo': {
      'name': 'Colombo',
      'center': mapbox.Point(coordinates: mapbox.Position(79.8612, 6.9271)),
  ...
  // Set current map area - Now notifies listeners
  void setCurrentArea(String areaKey) {
    if (_currentAreaKey != areaKey) {
      _currentAreaKey = areaKey;
  ...
  Map<String, dynamic>? getAreaInfo(String areaKey) {
    return _hikingAreas[areaKey];
  }
}
